...
employees_button=Button(left_frame,image=employee_image,compound=LEFT,text="  Employees",font=("times new roman",20,"bold"),bg="SlateGray4",fg="WhiteSmoke",cursor="hand2",anchor="w",padx=10,command= lambda :employee_form(window))
